...
- CloudFlareパネルのバリデーション問題を修正。貢献してくれた\*\*@wrk-123\*\*氏に感謝する！
- 冗長なティア変更問題を修正。貢献してくれた\*\*@wrk-123\*\*氏に感謝する！
- type='button'\`属性を追加してbutton要素を改善し、フォームの誤送信を防ぐ。
- 翻訳コピーボタンが無効の場合のテキストを改善しました。
- コード送信フォームの構築方法を改善し、コード構造をシンプルにする。
- Luoguへのジャンプでトピックが見つからなかった場合の判定を改善！
- qjwh\*\*氏、**nr0728**氏、**wrk-123**氏の貢献により、ウェブサイトのローカリゼーション・ルールが改善された。
...
- wrk-123\*\*さんの貢献により、「同じフィールドの質問リストを表示する」機能を追加しました。
...
- オーバーレイ・クラス名の衝突を修正
- nr0728**氏、**@user111192**氏、**@qjwh\*\*氏の貢献により、ウェブサイトのローカリゼーション・ルールが改善された。
